...
void test_deserialize_DoId(void) {
...
void test_serialize_deserialize_DoId(void) {
  DoId message = DoId_init_default;
  message.id = 123;
  message.value = 4.56;
...
void test_serialize_DoId_invalid_buffer(void) {
  DoId message = DoId_init_default;
  message.id = 1;
  message.value = 1.0;
...
void test_deserialize_DoId_invalid_buffer(void) {
  DoId message = DoId_init_default;
